...
class EnterpriseScope(TimeStampedModel):
    ...
    # Opt-in root for the authenticated province-platform account. Only these
    # scopes may create enterprise children from observed platform payloads.
    allow_platform_enterprise_discovery = models.BooleanField(default=False)
...
class RoleAssignment(TimeStampedModel):
    class Role(models.TextChoices):
        UNIT_USER = "UNIT_USER", "采集员（只读）"
        MONITOR_OPERATOR = "MONITOR_OPERATOR", "监控操作员"
