...
class GovernanceTests(TestCase):
    ...
    def test_system_admin_does_not_receive_business_permissions(self):
        ...
        self.assertNotIn("rule.approve", data["permissions"])
        self.assertNotIn("export.masked", data["permissions"])
