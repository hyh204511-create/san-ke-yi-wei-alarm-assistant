...
class ReportingFlowTests(TestCase):
    def setUp(self):
        ...
        assign_role(user=self.reporter, role=RoleAssignment.Role.RULE_CONFIGURER, assigned_by=self.reporter)
    ...
    def test_overlapping_accounts_upsert_one_event_and_preserve_sources(self):
        ...
        assign_role(user=second, role=RoleAssignment.Role.UNIT_USER, assigned_by=second)
